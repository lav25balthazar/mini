...
void Robot::readSensors() {
  ...
  Serial.println("esq: ");
  this->left_sensor.distance_cm; // lê sensores analogicos chamando 
  Serial.println(this->left_sensor.distance_cm);
  Serial.println(" \t dir: ");
  this->right_sensor.distance_cm; // a funcao readSensor do analog_sensor
  Serial.println(this->right_sensor.distance_cm);
  
  this->front_sensor.enemy_close; // le sensores digitais chamando a 
  this->full_left_sensor.enemy_close; // funcao readSensor
  this->full_right_sensor.enemy_close; // do digital_sensor
